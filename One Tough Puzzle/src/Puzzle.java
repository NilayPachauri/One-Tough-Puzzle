...
public class Puzzle // class Puzzle
{
	...
	// // puzzle works
	// {
	// return testLeft(p, 1) && testLeft(p, 2) && testUp(p, 3) && testBoth(p, 4)
	// && testBoth(p, 5) && testUp(p, 6)
	...
	// // side
	// {
	// return p.board.get(piece - 1).getSides()[1] +
	// p.board.get(piece).getSides()[3] == 0;
	// }
	//
	...
	// // piece's bottom side
	// {
	// return p.board.get(piece - 3).getSides()[2] +
	// p.board.get(piece).getSides()[0] == 0;
	// }
	//
	// public static boolean testBoth(Puzzle p, int piece) // if the bottom
	// puzzle
	// // piece's top side fits
	// // with the top puzzle
	// // piece's bottom side
	...
	// return p.board.get(piece - 3).getSides()[2] +
	// p.board.get(piece).getSides()[0] == 0
	// && p.board.get(piece - 1).getSides()[1] +
	// p.board.get(piece).getSides()[3] == 0;
	// }
																...
																// the board
	{
		...
		try // try the following code
		{
			while ((line = br.readLine()) != null) // while information is left
			{
				...
				String[] parsedElements = line.split(","); // grab each element
															// and add
				// it to the array
				...
				board.add(new Piece(sides, "Piece " + count)); // add
																// each
																// piece
																// to
																// the
	...
	public String toString() {
		...
		for (Piece piece : board)	{
			s += piece.getName() + piece.getSides().toString() + " ";
		}
